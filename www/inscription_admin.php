...
<body> 
 ...
 <div class="topBarre2" style="position:fixed;top:0;margin-bottom:20px;">
 <a href="logout.php" style="float:left;text-transform:uppercase;color:red;line-height:40px;" >Se déconnecter</a>
 <a href="admin.php" style="float:right;text-transform:uppercase;color:red;line-height:40px;" >Retour</a>
 <div class="topBarre2Content">
<h1 class="name" style="text-align:center;">PAGE DES ADMINISTRATEURS</h1>'
 </div>
 </div>
 ...
 <p class="forfaitDesc">Cliquez sur le forfait souhaité.<br/>Exemple : 2 activités par semaine pendant six mois.</p>
 <a title="Quebec_files/horaire_AOUT2014.pdf" target="_blank" href="Quebec_files/horaire_AOUT2014.pdf" style="float:right;padding-top:22px;font-style:normal;font-size:13px;">Cliquez ici pour une version imprimable de l’horaire! </a>
...
<form name="inscription" method="post" action="ajout_abonnee_admin.php" onsubmit="return validateForm()" >
 
		 <table class="tableForm" style="float:left;">
		 <tr>
		 <td class="formLabel" style="width:40px;">Nom :</td>
		 <td><input class="input" type="text" placeholder="Entrez votre nom" style="width: 181px" required name="nom"></td> 
		 <td class="formLabel" >Prénom :</td>
		 <td><input class="input" type="text" placeholder="Entrez votre prénom" style="width: 181px" required name="prenom"></td>
		 </tr>

		  <tr>
		 <td class="formLabel" style="width:90px;">Date début :</td>
		 <td><input class="input" type="text" placeholder="ex: 2014-05-24" style="width: 181px" required name="debut"></td>
		  <td class="formLabel" style="width:70px;">Date fin :</td>
		 <td><input class="input" type="text" placeholder="ex: 2014-05-24" style="width: 181px" required name="fin"></td>
		 </tr>
		 
		 <tr>
		 <td class="formLabel" style="width:40px;">Tél. :</td>
		 <td><input class="input" type="text" placeholder="Téléphone" style="width: 181px" required name="phone"></td>
		 <td class="formLabel">Courriel :</td>
		 <td><input class="input" type="text" placeholder="Entrez votre courriel" style="width: 181px" required name="courriel"></td>
		 <td class="formLabel" style="width:35px;">Âge :</td>
		 <td><input class="input" type="number" required name="age" value="0" min="8" max="100"></td>
		 </tr>
		 </table>
		...
		<input type="hidden" name="on3" id="on3" value="" >
		 ...
		 <textarea name="decouverteAdd" rows="5" cols="79" style="resize:none;"></textarea>
		 </div>
...
<span class="etape">Étape 3 </span>
	<p class="forfaitDesc">Confirmer votre présence aux cours. Ce système est très souple et vous permet de venir quand vous voulez dans la semaine, mais vous avez <br/>la responsabilité de confirmer votre présence aux cours chaque semaine, au moins 3 heures à l’avance.</p>
	<div style="clear:both;border-bottom:1px dotted rgba(0,0,0,0.3);margin-bottom:15px;"></div> 


	<form method="post" action="mailCours.php">
		 ...
		 <button type="submit" class="submit"  name="submit" style="width:250px;float:left;">Confirmer ma présence</button>
		 <p style="font-size:12px;float:left;margin-top:10px;"><i><br/>*Une confirmation vous seras envoyée par courriel sous peu.</i></p>
	</form>
...
<h2>Les lieux</h2>
<p>Les <b>pratiques libres</b> et les cours <b>Force et mobilité</b> ont lieu dans notre salle au 88 rue St-Jean. Les autres cours se tiennent le plus souvent en plein air, sauf l’hiver et en cas d’orage.</p>
<p><b>* Les lundis, vendredis et samedis</b>, le point de rendez-vous est notre salle au 88 rue St-Jean.
    <p><b>* Les mardis, mercredis, jeudis et dimanches</b>, ils ont lieu le long de la rivière St-Charles (rendez-vous à l'entrée du Centre récréatif St-Roch, 230 rue du Pont).
   	
    <p><br/>Vérifiez de temps à autre cette section, car nous changeons parfois de point de ralliement! (Lorsque de tels changements ont lieu, c’est généralement le 1er du mois et les informations sont aussi relayées sur notre page <a href="https://www.facebook.com/addquebec" target="_blank">Facebook</a>).</p>
