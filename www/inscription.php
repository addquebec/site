        ...
        <div class="part1">
            ...
            <div class="forfaitsWrap">
                <div class="lesForfaits">
                    ...
                    <p style="text-align:left;">Que vous soyez débutant ou expérimenté, venez travailler votre physique et votre mental en remplissant de nombreux défis adaptés à vos capacités.</p>
                </div>

                <div class="lesForfaits">
                    <h3>ADD Jeunes</h3>
                    <p>Strictement réservé aux jeunes de 8 à 15 ans! Des jeux, des défis physiques, créatifs et
                        d’équipe, des techniques de passements d’obstacles… Aucune expérience requise, mais il faut avoir envie de fournir des efforts!</p>
                </div>

                <div class="lesForfaits" style="margin-right:0;">
                    <h3 style="text-align:right;">JAM / Porte ouverte / Atelier</h3>
                    <p style="text-align:right;">Nous organisons aussi des événements particuliers : retrouvez-nous aux beaux jours pour des JAM, et le reste de l'année, à nos portes ouvertes. De plus, nous offrons régulièrement des ateliers spécialisés. Surveillez notre facebook et venez nous rejoindre au 88 rue St-Jean!</p>
                </div>

                <div class="lesForfaits" style="text-align:left;">
                    <h3 style="text-align:left;">Entrainement libre</h3>
                    <p style="text-align:left;">Au 88 rue St-Jean, notre salle spécialement aménagée, modulable et évoluant au fil
                        des saisons. Venez vous entrainer à votre rythme!</p>
                </div>
            ...
            <div id="tarifs">
                <img src="images/tarifs.jpg" alt="" style=" margin-left: 125px;">
            </div>
